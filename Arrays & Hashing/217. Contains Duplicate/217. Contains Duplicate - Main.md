...
# LeetCode
[242. Contains Duplicate](https://leetcode.com/problems/contains-duplicate/description/)
...
# Process Record
- [x] [[217. Contains Duplicate - Ans 1 - Hash - N]]：20m
	- [x] 想法筆記
	- [x] 實作解題
- [x] [[217. Contains Duplicate - Ans 2 - Linear - Sqr(N)]]：10m
	- [x] 想法筆記
	- [x] 實作解題
