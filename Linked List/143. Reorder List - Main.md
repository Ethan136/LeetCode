...
public:
    void reorderList(ListNode* head) {
        ...
        // split list in tow: left+mid / right
        // (1) slow / fast ptr: slow shoudl stop on mid left (double mid) / mid (single mid)
        ListNode *slow = head;
        ...
        // (2) split list to left+mid / right
        ListNode *head2 = slow->next;
        slow->next = nullptr;

        // (3) reverse right list
        ListNode *node2 = head2;
        ListNode *node2Prev = nullptr;
        while(node2) {
        ...
        // finish
        // augmentedHead.next should be origin head
    }
};
```