...
class Solution {
private:
    TreeNode* buildTreeByPreorder(auto &preorder, int &preIdx, auto &inorder, int &inIdx, int stopByInOrd, int stopOnInOrdVal) {
        ...
        if(stopByInOrd && (inorder[ inIdx ] == stopOnInOrdVal)) return nullptr;
        ...
        node->right = buildTreeByPreorder(preorder, preIdx, inorder, inIdx, stopByInOrd, stopOnInOrdVal);
